...
export function NewsletterSection({
  ...
  return (
    <section
      ...
      {...props}
    >
      <div className="dark relative overflow-hidden w-full bg-black px-4 py-10 sm:px-8">
        {backgroundEffect && <BackgroundEffect />}
        <h2 className="mb-6 text-xl/[1.1] font-extrabold tracking-tight text-foreground md:text-2xl/[1.1]">{title}</h2>
