                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-baseline gap-1">
                        <span className="text-lg font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-blue-600">
                          Contact for Pricing
                        </span>
                      </div>
                    </div>
            ...
            <div className="relative rounded-2xl overflow-hidden">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="bg-white/90 backdrop-blur-sm rounded-xl p-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-baseline gap-1">
                      <span className="text-lg font-medium text-purple-600">Contact for Pricing</span>
                    </div>
                    <div className="flex items-center gap-1">
              ...
              <div className="absolute top-6 right-6">
                <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-3 py-2 rounded-lg shadow-lg">
                  ...
                  <div className="text-xs opacity-90">For Pricing</div>
                </div>
              </div>
            </div>
